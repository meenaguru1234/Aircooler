...
const Home = () => {
  ...
  const gridimage = [
    ...
    const handlePlay = ()=>{
        window.open("https://www.youtube.com/watch?v=s6NHxfKUkUo" )
    }
        ...
        <>
            <div id='maincontainer'>
                <div id="maincont">
                    <div id='fixednav'>
                        <div id='nav1'>
                            <div id='envato'><img src={require(`../images/Capture.PNG`)} alt="" style={{width:'90%'}} /></div>
                            <div><button id='buybtn'>Buy now</button></div>
                        </div>
                    </div>
                </div>
                <div id='subcontainer'
                    ...
                    <div id='leftsubcontainer'
                                ...
                                <div style={{ height: '500px', width: '95%' }}>
                                    ...
                                    <div class="about-image">
                                        ...
                                        <div className="vibrate-container">
                                            ...
                                            <button className="play-button"  onClick={handlePlay}><FaPlay /></button>
                                        </div>
                                        <div class="hover">
                      ...
                      <div id='overallcontainerdiv' style={{height:'100%',width:'100%', display:'flex', justifyContent:'space-around', 
                       ...
                       <div class="vertical-line" style={{}}>
                        ...
                        <div style={{height:'200px', width:'100%', border:'1px solid red', backgroundColor:'yellow'}}>

                        </div>
                       
                            <div id='footerdiv' style={{height:'600px', width:'100%'}}>
                                <Footerarea/>
                            </div>
                    ...
                    style={{height:'2000px',  overflowY: "auto", border: "1px solid black;" }} >
